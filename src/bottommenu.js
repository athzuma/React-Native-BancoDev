        ...
        <View style={styles.container}>
          ...
          { load &&
            <View style={{ padding: 40 }}>
              <ActivityIndicator size="large" color={setup.color.primary} />
              <Text style={{ color: setup.color.primary, fontSize: 18, textAlign: 'center', marginTop: 20 }}>Processando pagamento...</Text>
            </View>
          }
